...
export default function PressReleasesCategoryList() {
    ...
    const handleDeleteConfirm = async () => {
        try {
            await fetch(`${API_BASE_URL}/api/press-years/${confirmModal.yearsId}`, {
                method: "DELETE",
            });
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            let response;
            if (formMode === "edit") {
                response = await fetch(`${API_BASE_URL}/api/press-years/${editId}`, {
                    method: "PUT",
                ...
                response = await fetch(`${API_BASE_URL}/api/press-years`, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify(submitData),
                });
