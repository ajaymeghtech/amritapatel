   ...
   const [activeTab, setActiveTab] = useState("students");
    ...
    const testimonialsData = {
        students: {
            ...
            videos: [
                { id: "JSna82T2tm0", title: "Student Testimonial 1" },
                { id: "JSna82T2tm0", title: "Student Testimonial 2" }
            ]
        },
        ...
        faculty: {
            ...
            videos: [
                { id: "JSna82T2tm0", title: "Faculty Testimonial 1" }
            ]
        },
        ...
        community: {
            ...
            videos: [
                { id: "JSna82T2tm0", title: "Community Testimonial 1" }
            ]
        }
    };
